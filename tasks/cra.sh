...
scripts_path="$root_path"/packages/saber-vue-scripts/`npm pack`
...
cd "$root_path"
node packages/saber-vue-app/index.js --scripts-version="$scripts_path" "$@"
